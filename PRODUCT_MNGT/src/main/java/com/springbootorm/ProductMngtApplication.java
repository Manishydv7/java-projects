...
import com.springbootorm.repositories.ProductRepository;

@SpringBootApplication
//ProductMngtApplication class
public class ProductMngtApplication {
	//main method
	public static void main(String[] args) {
		ApplicationContext ac = SpringApplication.run(ProductMngtApplication.class, args);
		...
		while (c == 'y') {
			...
			case 2: {
				...
				switch (i1) {
				case 1: {
					System.out.println("Enter product id(product_id) for updation");
					int p_id = sc.nextInt();
					...
					pr.save(p21);
					System.out.println("updation of product name is done");
					break;
				}
				case 2: {
					System.out.println("Enter product id(product_id) for updation");
					...
					pr.save(p22);
					System.out.println("updation of product brand is done");
				...
				case 3: {
					...
					pr.save(p23);
					System.out.println("updationof product price is done");
					break;
				}
				default:
			...
			case 3: {
				...
				int ii = pr.removeByPname(del_name);
				if (ii == 0) {
...
//				System.out.println(ii);
			...
			case 4: {
				...
				System.out.println("choose option 2nd to fing by name");
			...
			//case 5
			case 5: {
				System.out.println("Have a nice day...gud bye");
				c = 'n';
				break;
			}
			//default case
